...
typedef enum {
	...
	STRAP_TYPE_INT,
	STRAP_TYPE_LONG_INT,
	STRAP_TYPE_LONG_LONG_INT,

	STRAP_TYPE_UNSIGNED_CHAR,
	STRAP_TYPE_UNSIGNED_SHORT,
	STRAP_TYPE_UNSIGNED_INT,
	STRAP_TYPE_UNSIGNED_LONG_INT,
	STRAP_TYPE_UNSIGNED_LONG_LONG_INT,
